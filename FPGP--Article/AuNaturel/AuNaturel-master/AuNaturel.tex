...
\title{On the origin and spread of feral pigeons}
\newcommand\shorttitle{Feral Pigeon Genomics}

\author{Emilio Pisanty\textsuperscript{1$\,*$}}
\author{Layka\textsuperscript{1$\,*$}}
\newcommand\shortauthor{Pacheco et al.}
