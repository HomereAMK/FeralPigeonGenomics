...
- The Rscript used to create the map presented as Figure 1 is available in [`FPG--Map`](https://github.com/layka-pacheco/FeralPigeonGenomics/tree/main/FPG--Pipeline/FPG--Plots/FPG--Map).
***
***
