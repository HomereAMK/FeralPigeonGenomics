### The BEGINNING ~~~~~
##
# ~ Plots FPG--UMAP | First written by Filipe G. Vieira with later modifications by George Pacheco.
...
pacman::p_load(optparse, tidyverse, plyr, RColorBrewer, extrafont, ggforce, ggstar, cowplot, ggpubr, methods, plotly)
...
opt<-list(in_file = "FPG--GoodSamples_NoSrisoriaNoCpalumbusNoCrupestrisNoDuplicates.cov",
          comp = "1-2", annot_file = "FPG--GoodSamples_NoSrisoriaNoCpalumbusNoCrupestrisNoDuplicates.annot",
          colannot = "Site", out_file = "TEMP.png")
...
PC[, opt$colannot] <- factor(annot[, opt$colannot])
...
opt$in_file = "FPG--GoodSamples_NoSrisoriaNoCpalumbusNoCrupestrisNoDuplicates.mds"
opt$annot = "FPG--GoodSamples_NoSrisoriaNoCpalumbusNoCrupestrisNoDuplicates.annot"
opt$id_column = 1
