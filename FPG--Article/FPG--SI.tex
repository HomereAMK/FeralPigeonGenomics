...
\begin{figure}[ht]
\centering
\includegraphics[width=1\textwidth]{../FPG--Plots/FPG--Stats/FPG--CovHeatMap/FPG--CovHeatMap.pdf}
\caption*{\scriptsize{\mytext{\textbf{Supplementary Fig. 1. Coverage heatmap.} Heatmap based on the presence/absence matrix. Individual samples are represented by each column, whereas clusters of loci are represented by the rows.}}}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{../FPG--Plots/FPG--Stats/FPG--CovDistribution/FPG--GoodSamples--GlobalCov.pdf}
\caption*{\scriptsize{\mytext{\textbf{Supplementary Fig. 1. Coverage heatmap.} Heatmap based on the presence/absence matrix. Individual samples are represented by each column, whereas clusters of loci are represented by the rows.}}}
