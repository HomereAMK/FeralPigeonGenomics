...
\caption[Supplementary Figure 1. Coverage heatmap.]{\textbf{Supplementary Figure 1. Coverage heatmap.} Columns represent individual samples, while rows represent clusters of loci. Those samples that failed to produce sufficient GBS reads and the blank samples are marked in purple.}
