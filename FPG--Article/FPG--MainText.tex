...
\caption*{ \scriptsize \textbf{Fig. 1 Sampling effort.} Map showing sampling localities Samples were divided into four categories: a) remote localities within natural range (green); b) urban localities within natural range (yellow), localities outside natural range (orange); d) captives (blue). The supposed natural range of \textit{Columbia livia} is depicted through a light green shade.}
